...
- **Why only one cable between two Macs?** — **Two cables between the same pair of bridged Macs can make the network hand the same traffic back and forth in a loop. One cable, no loop.**
